...
- Candidate result: `30/30` lifecycle contract assertions GREEN, including concurrent
  ...
  and transaction-wide import rollback.
- Enforced-assertion gate: `39/39` GREEN for
  `tests/test_enforced_assertions.bats tests/test_lifecycle_contract.bats`.
- Focused upstream gate: `188/188` GREEN for storage contract, messaging,
  inbox, API, watch, and lifecycle contract suites.
- Compatibility gate: `82/82` GREEN for the Bash 3.2-sensitive local quoting,
